...
module.exports = async function (context, req) {
    ...
    let download = ""
    let downloadpng = "https://jonathanrogersbitproject.blob.core.windows.net/images/" + username + ".png";
    let downloadjpg = "https://jonathanrogersbitproject.blob.core.windows.net/images/" + username + ".jpeg";
